#!/bin/bash
#7054 is the standard port

function generateMspAndCert() {
  peerNumber=$1

  infoln "Registering peer${peerNumber}"
  set -x
  fabric-ca-client register --caname ca-org1 --id.name peer${peerNumber} --id.secret peer${peerNumber}pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/org1/ca-cert.pem"
  { set +x; } 2>/dev/null


  infoln "Generating the peer${peerNumber} msp"
  set -x
  fabric-ca-client enroll -u https://peer${peerNumber}:peer${peerNumber}pw@localhost:7054 --caname ca-org1 -M "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer${peerNumber}.org1.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org1/ca-cert.pem"
  { set +x; } 2>/dev/null

  cp "${PWD}/organizations/peerOrganizations/org1.example.com/msp/config.yaml" "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer${peerNumber}.org1.example.com/msp/config.yaml"

  infoln "Generating the peer${peerNumber}-tls certificates, use --csr.hosts to specify Subject Alternative Names"
  set -x
  fabric-ca-client enroll -u https://peer${peerNumber}:peer${peerNumber}pw@localhost:7054 --caname ca-org1 -M "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer${peerNumber}.org1.example.com/tls" --enrollment.profile tls --csr.hosts peer${peerNumber}.org1.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/org1/ca-cert.pem"
  { set +x; } 2>/dev/null

  cp "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer${peerNumber}.org1.example.com/tls/tlscacerts/"* "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer${peerNumber}.org1.example.com/tls/ca.crt"
  cp "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer${peerNumber}.org1.example.com/tls/signcerts/"* "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer${peerNumber}.org1.example.com/tls/server.crt"
  cp "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer${peerNumber}.org1.example.com/tls/keystore/"* "${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer${peerNumber}.org1.example.com/tls/server.key"
...
function createOrg1() {
  ...
  # set -x
  # fabric-ca-client register --caname ca-org1 --id.name peer1 --id.secret peerpw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/org1/ca-cert.pem"
  # { set +x; } 2>/dev/null
